package com.golfzon.social.security.jwt;
...
public final class JwtTokenUtils {
    ...
    public static final String CLAIM_IMAGE_URL = "IMAGE_URL";
    ...
    public static String generateJwtToken(UserDetailsImpl userDetails) {
        ...
        try {
            token = JWT.create()
                    ...
                    .withClaim(CLAIM_NICK_NAME, userDetails.getMember().getNickname())
                    .withClaim(CLAIM_ROLE, userDetails.getMember().getRole())
                    .withClaim(CLAIM_IMAGE_URL, userDetails.getMember().getImgUrl())
